...
export default function HomeLoanPage() { return <CalculatorLayout calculatorSlug="home-loan" title="Home Loan EMI Calculator" description="See what the loan costs each month and how much interest it adds over the full tenure."><LoanCalculator enableComparison defaults={{ principal: "5000000", annualInterestRate: "8.5", tenureYears: "20" }} /></CalculatorLayout>; }
