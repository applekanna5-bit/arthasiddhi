...
export default function FdPage() { return <CalculatorLayout title="FD Calculator" description="Estimate your fixed deposit maturity amount for the rate, tenure and compounding frequency you choose."><FdCalculator /></CalculatorLayout>; }
