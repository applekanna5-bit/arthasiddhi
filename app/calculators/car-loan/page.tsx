...
export const metadata: Metadata = { title: "Car Loan EMI Calculator | ArthaSiddhi", description: "Calculate your car loan EMI, total interest and repayment schedule using ArthaSiddhi's free calculator." };
