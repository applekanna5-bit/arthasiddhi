...
export default function SipPage() { return <CalculatorLayout title="SIP Calculator" description="Estimate the potential future value of a regular monthly investment."><SipCalculator /></CalculatorLayout>; }
