...
export default function TermsPage() {
  return (
    <InfoPage eyebrow="Legal" title="Terms of Use" description="These terms apply when you access or use ArthaSiddhi. Last updated: 16 August 2026.">
      ...
      <section><h2 className="text-2xl font-bold text-slate-950">Calculator results and accuracy</h2><p className="mt-3">Results depend on the values and assumptions entered. Although reasonable care is taken in presenting calculations and content, completeness, accuracy, or suitability for a particular purpose is not guaranteed. Verify important figures against current lender, bank, investment-product, government, or qualified professional information.</p></section>
