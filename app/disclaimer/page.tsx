...
export default function DisclaimerPage() {
  return (
    <InfoPage eyebrow="Important information" title="Financial Disclaimer" description="ArthaSiddhi provides educational information and scenario-based estimates, not individualized financial or investment advice. Last updated: 17 August 2026.">
