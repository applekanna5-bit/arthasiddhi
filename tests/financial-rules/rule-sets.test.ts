...
import { epfRuleSet, financialRuleSets, gratuityRuleSet, incomeTaxRuleSet, npsRuleSet, ppfRuleSet } from "../../lib/financial-rules/rule-sets";

describe("financial rule registry", () => {
  it("uses stable, unique rule-set IDs", () => { const ids = Object.values(financialRuleSets).map((ruleSet) => ruleSet.id); expect(new Set(ids).size).toBe(6); expect(ids).toEqual(["income-tax-tax-year-2026-27", "ppf-scheme-2019-amended-2020", "gst-generic-arithmetic-2026-08", "epf-schemes-contributions-2026-08", "nps-all-citizen-exits-2026-07", "gratuity-social-security-code-2025-11"]); });
