...
export const personalFinanceArticles = [
  {
    ...
    sections: [
      ...
      { id: "using-calculators", heading: "Using the idea in a calculation", paragraphs: ["For an FD, use the rate, tenure and compounding frequency supplied by the bank. For a SIP or another market-linked investment, the return entered is only an assumption. Compare more than one assumption instead of treating a single projected value as certain."], callout: { title: "Compare the calculation", text: [{ text: "Use the " }, { text: "FD Calculator", link: { kind: "calculator", slug: "fd" } }, { text: " for a deposit with a stated rate, or the " }, { text: "SIP Calculator", link: { kind: "calculator", slug: "sip" } }, { text: " to see how monthly contributions and an assumed return affect projected value." }] } },
    ],
  },
