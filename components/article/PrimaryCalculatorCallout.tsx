...
import { getBankingGuideLink, isBankingArticleSlug, isHomeLoanPrimaryArticleSlug, isTaxArticleSlug, type HomeLoanPrimaryArticleSlug } from "@/lib/analytics";
...
export function PrimaryCalculatorCallout({ slug, articleSlug }: { slug: CalculatorSlug; articleSlug: ArticleSlug }) {
  ...
  const bankingAnalytics = getBankingGuideLink(isBankingArticleSlug(articleSlug) ? articleSlug : undefined, slug, "primary_callout");
